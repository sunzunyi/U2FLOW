...
if __name__ == '__main__':
    ...
    val_dataset = flow_datasets.KITTI2015(split='testing', three_frame=True)
    # val_dataset = flow_datasets.KITTI2012(split='testing', three_frame=True)

    output_path = f'logs/evaluate/kitti_submission/fusion_results/kitti2015/'
    ...
    for val_id in tqdm(range(len(val_dataset))): # len(val_dataset)    
        ...
        flow_pred_up = flow_pred_up.permute(1, 2, 0).numpy()
